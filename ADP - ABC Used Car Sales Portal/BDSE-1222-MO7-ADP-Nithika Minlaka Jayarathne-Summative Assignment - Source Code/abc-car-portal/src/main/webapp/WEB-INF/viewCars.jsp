...
<body>
	...
	<div class="container">
		<sec:authorize access="hasRole('Users')">
			<!-- post car link-->
			<div class="row p-3 mb-5" style="background-image: url(images/jeep.jpg);height: 255px; border-radius: 30px;">
				<div class="col-5" style="margin: 90px 0 0 20px;">
				...
				<div class="col col-lg-2" style="text-align: end; margin: auto;">
					...
					<div class="modal fade" id="exampleModal" tabindex="-1"
						...
						<div class="modal-dialog">
							<div class="modal-content" style="background: darkslategrey">

								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalLabel" style="color: white;">Sell Your
										Car Today!</h5>
								...
								<div class="modal-body" style="color: white;">
									...
									<sf:form action="car_post" method="post" class="was-validated"
										...
										<button type="submit" class="btn btn-danger d-flex">Post</button>
									</sf:form>
									<script>
						            $(document).ready(() => {
					...
					<c:if test="${c.sellStatus != 'sold'}">
						<div class="card" style="width: 400px">
							...
							<div class="card-body">
								...
								<h4 class="card-title">${c.model}&nbsp;${c.name}</h4>
								<p class="card-text">
